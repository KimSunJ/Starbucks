...
function moveSlide(num) {
    ...
    if (currentIdx == 0 || currentIdx == 3 || currentIdx == -3) {
        btn1.style.backgroundImage = "url('./imgs/main_prom_on.png')";
        btn2.style.backgroundImage = "url('./imgs/main_prom_off.png')";
        btn3.style.backgroundImage = "url('./imgs/main_prom_off.png')";
    } else if (currentIdx == 1 || currentIdx == -2) {
        btn2.style.backgroundImage = "url('./imgs/main_prom_on.png')";
        btn1.style.backgroundImage = "url('./imgs/main_prom_off.png')";
        btn3.style.backgroundImage = "url('./imgs/main_prom_off.png')";
    } else if (currentIdx == 2 || currentIdx == -1) {
        btn3.style.backgroundImage = "url('./imgs/main_prom_on.png')";
        btn1.style.backgroundImage = "url('./imgs/main_prom_off.png')";
        btn2.style.backgroundImage = "url('./imgs/main_prom_off.png')";
    }
...
btn1.addEventListener('click', () => {
    pause.style.display = "url('./imgs/main_prom_play.png')";
...
pause.onclick = () => {
    checkNum++;
    if (checkNum % 2 != 0) {
        pause.style.backgroundImage = "url('./imgs/main_prom_play.png')";
        clearInterval(slideImg);
    } else {
        pause.style.backgroundImage = "url('./imgs/main_prom_stop.png')";
        slideImg = setInterval(reset, 3000);
        console.log(pause);
    }
};
